...
@section('content')
    ...
    <div>
        <select class="js-example-basic-single" name="products[]" multiple="multiple">
    ...
    <div id="product_price_range">
        <canvas class="canvasChartProduct" height="300" width="300" style="margin: 15px 10px 10px 0">
        </canvas>
    </div>
    <div>
        <div id="output"></div>
...
@section('scripts')
    ...
    <script type="text/javascript">
        $(function() {
            ...
            $.ajax({
                url: '/admin/reporting/all-data-product',
                type: 'get',
                dataType: 'json',
            })
            .done(function(res) {
            ...
            var productPriceRange = {
                ...
                init: function ($el) {
                    ...
                    $el = $($el);
                    $.ajax({
                        url: '/admin/reporting/chart-product',
